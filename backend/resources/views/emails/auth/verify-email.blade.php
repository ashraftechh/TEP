    ...
    <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-bottom: 24px;">
        <tr>
            <td style="background-color: #f1f5f9; border: 1px solid #e2e8f0; border-radius: 8px; padding: 14px 18px; font-size: 13px; color: #475569;">
                <strong style="color: #0f172a;">&#9432; {{ __('emails.verify_email.expire_notice', ['count' => $expireMinutes ?? 60]) }}</strong>
                <div style="margin-top: 4px; font-size: 12px; color: #64748b;">
                    {{ __('emails.verify_email.no_action_required') }}
                </div>
            </td>
        </tr>
    </table>
